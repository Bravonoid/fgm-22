...
import Bg_pattern from '../../../../assets/Pasar-Rakyat/bg-pattern.svg'
const Tenant = ({ tenantList, categoryName }) => {
  ...
  return (
    <div className="flex w-full  flex-col items-center bg-top bg-auto pt-5 pb-20" style={{ backgroundImage: `url(${Bg_pattern})` }}>
