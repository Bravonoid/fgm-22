		...
		<div className="h-full w-full bg-fgm-base py-16">
			...
			<div className="h-full xl:h-screen ">
				...
				<div className="hidden w-full  flex-col items-center  justify-center py-32 text-white xl:flex ">
					<div className="mb-16 text-3xl font-bold italic">Linimasa</div>
					<div className="flex w-full  flex-col items-center justify-center">
						...
						<div className=" mt-8 w-[65%]  px-12">
							<div className="flex w-full items-center justify-between">
								<div className="text-center">31 Oktober 2022 </div>
								<div className="text-center">13 November 2022</div>

								<div className="text-center">15 November 2022</div>
				...
				<div className=" flex  w-full flex-col items-center justify-center   py-16 text-white xl:hidden ">
					<div className="mb-6 text-3xl font-bold italic">Linimasa</div>
					<div className="flex w-full items-center justify-center ">
						<div className="grid h-[32rem] grid-cols-1 ">
							<div className="px-5 text-right">
								<p>Pembukaan Masa PO</p>
								<p>31 Oktober 2022</p>
							</div>
							<div className="text-right"></div>

							<div className="px-5 text-right">
								<p>Pengiriman Kode Unik</p>
