    ...
    <>
      <div className="items-center bg-[#171717] pb-[10rem] xl:pb-[20rem]">
        <div className="relative md:top-24 md:mx-auto md:grid md:grid-cols-4 xl:top-48 mobile:top-0 mobile:flex mobile:flex-col" >
          <div className="col-span-2 mt-8 hidden items-center justify-center md:block lg:mt-12 mobile:mt-32" data-aos="fade-right" data-aos-duration="1500">
            <div>
          ...
          <div className="items-left relative col-span-2 mx-10 mr-24 pt-36 text-left text-white md:my-5 xl:w-3/4 mobile:mx-10 mobile:text-base" data-aos="fade-down" data-aos-duration="1500">
