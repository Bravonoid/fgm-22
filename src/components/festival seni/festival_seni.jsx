...
import olski_photo from "../../assets/festival-seni/olski.png";
import guyon_waton_photo from "../../assets/festival-seni/guyon_waton.png";
import smash from "../../assets/festival-seni/smash.png";
import project_pop from "../../assets/festival-seni/project_pop.png";
import the_overtunes from "../../assets/festival-seni/the_overtunes.png";
import ask from "../../assets/festival-seni/ask_me.svg";
import ukm1 from "../../assets/festival-seni/judulkolaborasi.svg";
...
const festival_seni = () => {
	...
	return (
		<>
			<div
				id="content1"
				className="bg-cover pt-16 sm:bg-festival_md mobile:h-fit  mobile:bg-festival_mobile mobile:bg-cover"
			>
				<div className="top-10 mt-12 pb-8 sm:w-[575px]">
					...
					>
						...
						<p className="mt-2 w-full text-justify text-lg mobile:w-2/3 mobile:text-sm">
