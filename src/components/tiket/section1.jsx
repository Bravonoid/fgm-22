...
import Regular from "../../assets/tiket/Regular.png";
...
import RegularSM from "../../assets/tiket/RegularSM.png";
			...
			<div className=" mx-8 mt-8  mb-2 h-full w-full  flex-row justify-center pt-8 md:px-16">
				...
				>
					<div className="flex h-32 items-center justify-between sm:w-full ">
						...
						<img
							className="pointer-events-none mx-auto h-10 sm:h-16"
							src={Judul_pentas}
						></img>
			...
			<div className=" my-2  mx-8 h-full w-full flex-row justify-center pt-8 md:px-16">
				...
				>
					<div className="flex h-32  items-center justify-between sm:w-full ">
						...
						<img
							className="pointer-events-none mx-auto h-8 sm:h-10 "
							src={FestivalSeni}
						></img>
				...
				<div className="my-16 mx-8 h-full xl:mx-32 xl:px-8">
					<div className="pointer-events-none flex  h-full w-full flex-col items-center justify-between gap-4 sm:h-[36rem] md:h-[42rem] ">
						<div
							data-aos="fade-right"
							data-aos-duration="1000"
							data-aos-delay="500"
						...
						>
							...
							/>
							<img
								className="pointer-events-none block h-[25rem] sm:hidden"
								src={EarlyBirdSM}
								alt=""
							/>
						</div>
				...
				<div
					className="flex h-auto flex-col items-center justify-center gap-2 py-4 pb-20 mobile:top-0"
					data-aos="zoom-in"
					data-aos-duration="1000"
				...
				>
					<img
						src={judul}
						alt="judul"
						className="pb-20 sm:hidden md:block mobile:hidden"
					/>
					<img
						src={judulmobile}
						alt="judul"
						className="pb-20 sm:block md:hidden mobile:block"
					/>
					<div
						className={` z-100 relative  my-auto mx-auto flex h-3/5 w-4/5 bg-[#EEEEEE] bg-contain p-5  py-16 xl:bg-flat-kkm 2xl:w-2/3 mobile:mt-12`}
						data-aos="zoom-in"
						data-aos-duration="1000"
					>
						<div className="mx-auto h-auto px-10 lg:w-[1140.88px]">
							<div className="grid w-auto sm:grid-cols-2 lg:grid-cols-3 mobile:grid-cols-1">
								{dataFoto.map((item) => (
									<img
										src={require("../../assets/tiket/" + item.img + ".png")}
										alt={item.name}
