...
const Foto = () => { 
  ...
  return (
   ...
   <div       className={'relative  w-full md:w-3/4 h-[750px]  overflow-hidden ' }>
   ...
   <div className='absolute py-5 xl:py-20 mx-auto flex w-[90%] sm:w-[80%] md:w-[90%] xl:w-[80%] 2xl:w-[65%] text-white flex-col-2  z-20'>
        <div className='w-full'>
        <div className='bg-fgm-base-terang xl:w-[80%]  w-full  md:w-[65%] md:min-w-[80%] py-5 xl:pl-16 pr-4 px-4'>
          <img className='h-8 xl:h-12' src={Judul_teater}>
          </img>
          <p className='text-sm md:text-base xl:text-2xl font-bold'>
...
Pementasan ini mengangkat tema keberagaman budaya Nusantara yang akan digambarkan melalui kisah kerajaan di Indonesia. Setiap kerajaan akan mewakili emosi dasar yang manusia miliki, seperti marah, sedih, bahagia, takut, jijik, dan terkejut. Pementasan ini akan dibawakan secara fragmentasi berdasarkan tiga kisah kerajaan Indonesia yaitu Kerajaan Singosari, Mataram, dan Majapahit. 
    ...
    {DataSliderTeater.map((item) =>(
      <>
                ...
                <div className='bg-cover bg-center  w-full h-[750px] relative ' style={ {backgroundImage: `url('/img/${item.img}')`}}> 
    ...
    <div className='text-start order-first  bg-fgm-base-terang md:order-last p-5 items-start z-100  '>
      <ul className='flex md:inline-block text-white justify-center items-center md:m-8 gap-2 md:text-3xl  text-sm sm:text-lg '>
