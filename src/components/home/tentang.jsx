...
const tentang = () => {
  return (
    <div className="h-[70vh] items-center bg-[#1E1E1E]">
      <img
        src={gunungan}
      ...
      <div className="relative sm:top-32 sm:-right-8 sm:mx-auto sm:grid sm:grid-cols-2 xl:-right-40 xl:top-48 xl:ml-[50px] mobile:flex mobile:flex-col-reverse">
        <div className="relative items-end text-left text-white sm:-top-10 sm:my-5 sm:mb-[100px] xl:-top-16 xl:w-4/5 mobile:top-24 mobile:mx-10 mobile:text-sm">
