			...
			<div className="relative sm:mx-auto sm:grid sm:grid-cols-2 mobile:flex mobile:flex-col-reverse">
              ...
              ></img> */}
					...
					<div className="text-justify sm:text-base xl:text-3xl">
						...
						kreasi seni dan budaya tradisional melalui pengemasan yang modern.
						Pada tahun ini, Festival Gadjah Mada akan menyemarakkan rangkaian
					...
					<Link to="/tentang">
						<button
							...
							class="mt-4 rounded bg-white py-2 px-6 font-Montserrat text-lg text-black transition-all duration-300 ease-out hover:scale-[1] hover:px-[1.33rem] hover:font-bold hover:shadow-[5px_5px_0_rgb(128,128,128)]  mobile:text-sm"
						>
							Selengkapnya
						</button>
					</Link>
