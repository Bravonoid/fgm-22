...
const tentang = () => {
	return (
		<div className="h-[80vh] w-full items-center justify-end bg-[#1E1E1E]">
			<img
				src={gunungan}
				className="absolute sm:h-3/4 md:w-1/4 lg:w-1/5 xl:w-1/6 xl:scale-[2] mobile:w-2/5 mobile:top-80"
				alt="gunungan"
			></img>
			<div className="relative sm:mx-auto sm:grid sm:grid-cols-2 sm:top-32 sm:-right-8 xl:-right-40 xl:top-48 xl:ml-[50px] mobile:flex mobile:flex-col-reverse">
				<div className="relative sm:-top-10 sm:my-5  w-full items-end text-left text-white sm:mb-[100px] xl:-top-16 mobile:top-24 mobile:mx-10 mobile:text-sm">
					<div className="font-bold sm:text-3xl md:text-4xl lg:text-5xl xl:mb-5 xl:text-5xl">
						...
						<div className="flex sm:gap-1.5 md:gap-1 xl:gap-[8.5rem] mobile:gap-1.5 mobile:w-1/2">
							<p className="font-Montserrat mobile:text-2xl mobile:font-bold">FESTIVAL </p>
							<img
						...
						<div className="flex sm:gap-1 xl:gap-[7.8rem] mobile:gap-1">
							<p className="font-Montserrat mobile:text-2xl mobile:font-bold">GADJAH MADA</p>
							<img
					...
					<div className="xl:text-xl mobile:w-4/5 sm:text-base">
