        ...
        >
          ...
          <Link to="/tentang">
            <button
              ...
              class="mt-4 rounded bg-white py-2 px-6 font-Montserrat text-lg text-black hover:px-[1.33rem] hover:font-bold mobile:text-sm transition-all duration-300 ease-out hover:scale-[1]  hover:shadow-[5px_5px_0_rgb(255,255,255)] hover:text-white hover:bg-black"
            >
              Selengkapnya
            </button>
          </Link>
