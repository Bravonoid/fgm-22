...
const footer = () => {
  return (
    ...
    <div className="container mx-auto py-32 px-2 text-left sm:w-auto lg:w-full">
        <div className="flex mobile:flex-col lg:flex-row justify-evenly mobile:text-2xl mobile:gap-8 lg:items-start gap-y-2 md:gap-0 mx-4">
            {/* Nesco dan sosmed */}
            ...
            <img src={sitemap_footer} alt="" className='h-10 mobile:h-auto mobile:mr-16 mobile:ml-4' />
            <div className="mobile:ml-4 flex flex-col mobile:gap-2">
            ...
            <img src={ikuti_footer} alt="" className='h-10 mobile:h-auto mobile:mr-10 mobile:gap-4 mobile:ml-4 mobile:mb-2' />
            <div className="mobile:ml-4 flex flex-col mobile:gap-2">
