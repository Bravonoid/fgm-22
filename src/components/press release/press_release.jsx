        ...
        <>
            <div className="bg-[#202020] relative overflow-hidden h-auto text-white">
                <div className='flex flex-col mt-20 items-center justify-center'>
                    ...
                    <div className="text-justify text-base w-fit mobile:px-5 sm:px-20 lg:px-[200px] gap-y-12">
                        <img src={picture} alt="" className="mobile:w-full sm:w-4/5 md:w-3/4 lg:w-3/5 xl:w-1/2 mx-auto py-12"/>
                        ...
                        <img src={picture1} alt="" className="mobile:w-full sm:w-4/5 md:w-3/4 lg:w-3/5 xl:w-1/2 mx-auto py-12"/>
                        ...
                        <img src={picture2} alt="" className="mobile:w-full sm:w-4/5 md:w-3/4 lg:w-3/5 xl:w-1/2 mx-auto py-12"/>
                        ...
                        <img src={picture3} alt="" className="mobile:w-full sm:w-4/5 md:w-3/4 lg:w-3/5 xl:w-1/2 mx-auto py-12"/>
