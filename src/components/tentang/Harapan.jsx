    ...
    <>
      <div className="flex w-full bg-[#171717] md:pb-10 xl:pb-0 mobile:pt-1">
        <img
          ...
          data-aos-offset={window.innerHeight * .6}
        ...
        >
          <h1 className="text-weight-700 mt-10 text-center text-3xl font-bold text-white" data-aos="fade-down" data-aos-offset={window.innerHeight * .6}
          ...
          data-aos-duration="1500" data-aos-offset={window.innerHeight * .6}>
