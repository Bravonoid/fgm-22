...
const Harapan = () => {
  return (
    <>
      <div className="flex h-[50vh] w-full bg-[#1E1E1E] md:h-[35vh] mobile:pt-10">
        <img src={BackgroundKembangKiri} className="hidden md:flex" alt="" />
        <div className="container mx-auto px-10 md:px-72">
          <h1 className="text-weight-700 mt-10 text-center text-3xl font-bold text-white">
            <span className="bg-[#242424] px-10">HARAPAN</span>
          </h1>
          <h2 className="text-weight-700 mt-4 md:text-center text-right text-2xl text-white">
      ...
      <div className="flex h-[10vh] md:hidden items-center justify-center w-full bg-[#1E1E1E] md:h-[35vh]">
