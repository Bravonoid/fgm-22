...
const ActiveTab = () => {
  ...
  return (
    <>
      <div
        className="flex w-full justify-center bg-[#171717] pt-20 lg:pt-20"
        id="tema"
      >
        <div
        ...
        >
          <h2
            ...
            className={
              tema
                ? "text-[20px] font-bold text-white opacity-100 hover:cursor-pointer md:text-[40px]"
        ...
        <div data-aos="zoom-in" data-aos-duration="2000">
          ...
          <div className={tagline ? "block" : "hidden"}>
            <div className="mx-5 items-center justify-center">
              <a href="https://www.instagram.com/reel/CgCI58Th3NU/?igshid=YmMyMTA2M2Y=">
                <img
                  src={TaglineMobile}
