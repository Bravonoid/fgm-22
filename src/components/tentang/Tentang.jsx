...
const Tentang = () => {
  ...
  return (
    <div className={ button ? "items-center bg-[#171717] py-36 pt-[15rem] md:py-28 md:pt-[7rem]" : "items-center bg-[#171717] py-36 md:py-28"}>
      <div className="relative sm:mx-auto sm:grid sm:grid-cols-3 mobile:flex mobile:flex-col">
        ...
        >
          ...
          <p className="mt-5 mb-5 hidden text-justify text-lg sm:flex xl:text-xl mobile:text-base">
            Festival Gadjah Mada (FGM) merupakan sebuah acara apresiasi seni
            tahunan yang diselenggarakan di bawah kepengurusan BEM KM UGM yang
            diprakarsai oleh Kementerian Kreasi BEM KM UGM. FGM diselenggarakan
            sebagai penutup sekaligus puncak perjalanan dari “Kabinet Pijaraya”,
            BEM KM UGM 2022. FGM akan melibatkan relawan dari kalangan mahasiswa
            UGM dalam pelaksanaannya. Pada tahun ini, FGM menyajikan kreasi
            budaya dan seni tradisional melalui pengemasan yang modern serta
            akan disemarakkan melalui berbagai rangkaian acara, yaitu Pentas
            Teater ‘Wirama Bhatara Kertagama’ yang akan diselenggarakan pada
            tanggal 18 November 2022 di Taman Budaya Yogyakarta dan Festival
            Seni ‘Padika Prasara’ yang digelar bersamaan dengan Pasar Rakyat
            ‘Prapti Hita Abhipraya Jagaddhita’ pada tanggal 26 November 2022 di
          ...
          <a onClick={handleButton} href="#tema">
            <button class="mr-5 rounded bg-[#4A8068] py-2 px-6 font-Montserrat text-lg text-[#EEEEEE] transition-all duration-300 ease-out hover:bg-[#2E5343] hover:px-[1.36rem] hover:font-bold hover:shadow-[5px_5px_0_#4A8068] mobile:mr-3 mobile:px-3 mobile:text-base">
              Tema Besar
            </button>
          </a>
          <a onClick={handleButton} href="#maskot">
            <button class="rounded bg-[#9C4A9A] py-2 px-6 font-Montserrat text-lg text-[#EEEEEE] transition-all duration-300  ease-out hover:bg-[#693268] hover:px-[1.4rem] hover:font-bold hover:shadow-[5px_5px_0_#9C4A9A] mobile:px-3 mobile:text-base">
              Cindaru
            </button>
          </a>
        </div>
